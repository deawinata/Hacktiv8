    ...
    render() {
        return (
            <div className={'container-column'} style={{
                ...
                <p style={{fontWeight: 'bold', fontSize: 18, marginBottom: 0}}>{this.props.date}<br/><br/>{this.props.title}</p>
        ...
        return (
            <div>
                ...
                <div className='container-column'
                    ...
                    <p>Hello, JavaScript & Node.js Ninjas!<br/>Get ready for our monthly meetup JakartaJS! This will be
                        our
                ...
                <p style={{margin: 20, fontWeight: '500', fontSize: 15}}>Come and meet other developers interested in
                    the JavaScript and its library in the Greater Jakarta area.<br/>Twitter @JakartaJS and we use the
                    #jakartajs hashtag.</p>
                ...
                <div className={'container-row'} style={{margin: 20}}>
                    {this.state.pastMeetupList.map((item, i) => {
                        return (
                            <PastMeetup key={i} date={item.date} title={item.title} people={item.people}/>
                        )
                    })}
                </div>
